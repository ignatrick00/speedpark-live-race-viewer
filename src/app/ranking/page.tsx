...
type TabType = 'pilotos' | 'karts' | 'escuderias';

export default function RankingPage() {
  const [activeTab, setActiveTab] = useState<TabType>('pilotos');
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-midnight via-racing-black to-midnight">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
              ...
              <button
                ...
                className={`px-6 py-3 font-racing text-lg transition-all duration-200 ${
                  activeTab === 'pilotos'
                    ...
                    : 'text-sky-blue/60 hover:text-sky-blue hover:bg-gold/5'
                }`}
              >
                👤 PILOTOS
              </button>
          ...
          {/* Race Browser V0 Component - Always visible below tabs */}
          <div className="mb-8">
            <RaceBrowserV0 />
          </div>
        </div>
