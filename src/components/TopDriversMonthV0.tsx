...
export default function TopDriversV0Month() {
  ...
  const fetchBestTimes = async () => {
    try {
      ...
      const response = await fetch('/api/best-times-v0?period=month&type=drivers');
  ...
  return (
    <div className="bg-gradient-to-br from-racing-black/90 to-racing-black/70 border border-electric-blue/20 rounded-lg p-6">
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-sky-blue/50 mt-1">Últimos 30 días</p>
      </div>
